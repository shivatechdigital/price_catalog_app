...
/// available) and then renders the full [AdminRequirementDetailScreen].
class AdminRequirementRouteScreen extends ConsumerWidget {
  final String requirementId;

  const AdminRequirementRouteScreen({super.key, required this.requirementId});
    ...
    return Scaffold(
      ...
      body: requirementAsync.when(
        ...
        data: (requirement) {
          ...
          return AdminRequirementDetailScreen(requirement: requirement);
        },
      ),
    );
  }
